...
async function editStudent(std){
	...
	console.log("Any reductions made can't be reverted.");
	...
	let timeFrom = parseInt(answer2);
	let timeTo = parseInt(answer3);
...
async function addShift(){
	...
	let timeFrom = parseInt(answer3);
	let timeTo = parseInt(answer4);
...
function displayRelations(){
	...
	for(let i = 0; i<len; i++){
		...
		let stdNOW = sft.assignedStudents().get(0);
